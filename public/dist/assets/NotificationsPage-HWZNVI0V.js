import{f as e,l as t,m as n,n as r}from"./AppContext--62sVfXp.js";import{t as i}from"./plus-Bjrf0vhw.js";import{t as a}from"./search-vzNeoSfr.js";import{t as o}from"./trash-2-C3HSgrZL.js";import{t as s}from"./user-BIvNr_2C.js";import{D as ee,b as te,l as c,n as l,r as u,t as ne,v as d,w as re,y as f}from"./index-CGE6CGp4.js";var ie=f(`circle-check`,[[`circle`,{cx:`12`,cy:`12`,r:`10`,key:`1mglay`}],[`path`,{d:`m9 12 2 2 4-4`,key:`dzmm74`}]]),p=f(`info`,[[`circle`,{cx:`12`,cy:`12`,r:`10`,key:`1mglay`}],[`path`,{d:`M12 16v-4`,key:`1dtifu`}],[`path`,{d:`M12 8h.01`,key:`e9boi3`}]]),m=f(`layers`,[[`path`,{d:`M12.83 2.18a2 2 0 0 0-1.66 0L2.6 6.08a1 1 0 0 0 0 1.83l8.58 3.91a2 2 0 0 0 1.66 0l8.58-3.9a1 1 0 0 0 0-1.83z`,key:`zw3jo`}],[`path`,{d:`M2 12a1 1 0 0 0 .58.91l8.6 3.91a2 2 0 0 0 1.65 0l8.58-3.9A1 1 0 0 0 22 12`,key:`1wduqc`}],[`path`,{d:`M2 17a1 1 0 0 0 .58.91l8.6 3.91a2 2 0 0 0 1.65 0l8.58-3.9A1 1 0 0 0 22 17`,key:`kqbvx6`}]]),ae=f(`message-square`,[[`path`,{d:`M22 17a2 2 0 0 1-2 2H6.828a2 2 0 0 0-1.414.586l-2.202 2.202A.71.71 0 0 1 2 21.286V5a2 2 0 0 1 2-2h16a2 2 0 0 1 2 2z`,key:`18887p`}]]),h=f(`send`,[[`path`,{d:`M14.536 21.686a.5.5 0 0 0 .937-.024l6.5-19a.496.496 0 0 0-.635-.635l-19 6.5a.5.5 0 0 0-.024.937l7.93 3.18a2 2 0 0 1 1.112 1.11z`,key:`1ffxy3`}],[`path`,{d:`m21.854 2.147-10.94 10.939`,key:`12cjpa`}]]),oe=f(`volume-2`,[[`path`,{d:`M11 4.702a.705.705 0 0 0-1.203-.498L6.413 7.587A1.4 1.4 0 0 1 5.416 8H3a1 1 0 0 0-1 1v6a1 1 0 0 0 1 1h2.416a1.4 1.4 0 0 1 .997.413l3.383 3.384A.705.705 0 0 0 11 19.298z`,key:`uqj9uw`}],[`path`,{d:`M16 9a5 5 0 0 1 0 6`,key:`1q6k2b`}],[`path`,{d:`M19.364 18.364a9 9 0 0 0 0-12.728`,key:`ijwkga`}]]),g=n(e(),1),_=t();function v(){let{lang:e,t,triggerConfirm:n}=r(),{availableGrades:f}=ee(),{notifications:v,handleSendNotification:y,handleMarkNotificationAsRead:b,handleDeleteNotification:x,handleDeleteAllNotifications:S}=re(),{students:C}=ne(),{teachers:w}=te(),[se,T]=(0,g.useState)(!1),[E,ce]=(0,g.useState)(``),[D,O]=(0,g.useState)(`all`),[k,A]=(0,g.useState)(``),[j,le]=(0,g.useState)(`all`),M=(t,r)=>{t.stopPropagation(),n({title:e===`ar`?`حذف الإشعار`:`Delete Notification`,message:e===`ar`?`هل أنت متأكد من حذف هذا الإشعار نهائياً؟`:`Are you sure you want to permanently delete this notification?`,onConfirm:()=>{x(r)}})},N=()=>{n({title:e===`ar`?`حذف جميع الإشعارات`:`Delete All Notifications`,message:e===`ar`?`هل أنت متأكد من حذف جميع الإشعارات نهائياً؟ هذا الإجراء لا يمكن التراجع عنه!`:`Are you sure you want to delete all notifications permanently? This action cannot be undone!`,onConfirm:()=>{S()}})},[P,F]=(0,g.useState)(`parents`),[I,L]=(0,g.useState)(C.length>0?C[0].id:``),[R,z]=(0,g.useState)(f.length>0?f[0]:``),[B,V]=(0,g.useState)(w.length>0?w[0].id:``),[H,U]=(0,g.useState)(``),[W,G]=(0,g.useState)(``),[K,q]=(0,g.useState)(``),[J,Y]=(0,g.useState)(``),ue=t=>{if(t.preventDefault(),!H.trim()||!W.trim())return;let n=new Date().toISOString().replace(`T`,` `).substring(0,16),r={};if(P===`student`){let e=C.find(e=>e.id===Number(I));r={studentId:Number(I),studentName:e?e.name:null,studentNameEn:e?e.nameEn:null}}else if(P===`class`)r={grade:R};else if(P===`teacher`){let e=w.find(e=>e.id===Number(B));r={teacherId:Number(B),teacherName:e?e.name:null,teacherNameEn:e?e.nameEn:null}}let i={id:Date.now(),title:H,content:W,date:n,type:P,...r},a=[];if(P===`student`){let t=C.find(e=>e.id===Number(I));if(t){let r=e===`ar`?`تنبيه خاص بخصوص ابنكم ${t.name}: ${H} - ${W}. رياض و مدارس انوار العلى.`:`Private alert for ${t.nameEn}: ${H} - ${W}. Riyadh & Anwar Al-Ola.`;a.push({id:Date.now(),studentId:t.id,recipient:t.phone,text:r,time:n.split(` `)[1],type:`present`})}}else P===`class`?C.filter(e=>e.grade===R).forEach((t,r)=>{let i=e===`ar`?`تعميم لصف ${R}: ${H} - ${W}.`:`Class announcement for ${R}: ${H} - ${W}.`;a.push({id:Date.now()+Math.random()+r,studentId:t.id,recipient:t.phone,text:i,time:n.split(` `)[1],type:`present`})}):P===`parents`&&C.forEach((t,r)=>{let i=e===`ar`?`إشعار عام من المدرسة لأولياء الأمور: ${H} - ${W}.`:`Broadcast Announcement to Parents: ${H} - ${W}.`;a.push({id:Date.now()+Math.random()+r,studentId:t.id,recipient:t.phone,text:i,time:n.split(` `)[1],type:`present`})});y(i,a),T(!1),U(``),G(``),q(``),Y(``)},X=(0,g.useCallback)(t=>t.type===`attendance`?{name:e===`ar`?`مشرف التحضير`:`Prep Supervisor`,key:`supervisor`}:{name:e===`ar`?`إدارة المدرسة`:`School Administration`,key:`admin`},[e]),Z=(0,g.useMemo)(()=>v.filter(e=>!(e.title.toLowerCase().includes(E.toLowerCase())||e.content.toLowerCase().includes(E.toLowerCase()))||k&&!e.date.startsWith(k)||j!==`all`&&X(e).key!==j?!1:D===`all`?!0:D===`parents`?e.type===`parents`||e.type===`general`:D===`teachers`?e.type===`teachers`||e.type===`teacher`:D===`classes`?e.type===`class`:D===`private`?e.type===`student`||e.type===`private`:!0),[v,E,k,j,D,X]),de=v.length,fe=(0,g.useMemo)(()=>v.filter(e=>e.type===`parents`||e.type===`general`).length,[v]),pe=(0,g.useMemo)(()=>v.filter(e=>e.type===`class`).length,[v]),me=(0,g.useMemo)(()=>v.filter(e=>e.type===`student`||e.type===`private`).length,[v]),Q=(0,g.useMemo)(()=>C.filter(e=>e.name.toLowerCase().includes(K.toLowerCase())||e.id.toString().includes(K)),[C,K]),$=(0,g.useMemo)(()=>w.filter(e=>e.name.toLowerCase().includes(J.toLowerCase())||e.id.toString().includes(J)),[w,J]),he=(t,n,r,i,a,o)=>{if(t===`general`||t===`parents`)return{label:e===`ar`?`عام لأولياء الأمور`:`All Parents`,colorClass:`badge-parents`,gradientBorder:`var(--gradient-brand)`,icon:(0,_.jsx)(u,{size:15})};if(t===`class`)return{label:e===`ar`?`الصف: ${n}`:`Class: ${n}`,colorClass:`badge-class`,gradientBorder:`var(--gradient-warning)`,icon:(0,_.jsx)(m,{size:15})};if(t===`student`||t===`private`){let t=e===`ar`?r:i||r;return{label:e===`ar`?`طالب: ${t}`:`Student: ${t}`,colorClass:`badge-student`,gradientBorder:`var(--gradient-error)`,icon:(0,_.jsx)(c,{size:15})}}else if(t===`teachers`)return{label:e===`ar`?`جميع المعلمين`:`All Teachers`,colorClass:`badge-teachers`,gradientBorder:`var(--gradient-success)`,icon:(0,_.jsx)(u,{size:15})};else if(t===`teacher`){let t=e===`ar`?a:o||a;return{label:e===`ar`?`المعلم: ${t}`:`Teacher: ${t}`,colorClass:`badge-teacher`,gradientBorder:`linear-gradient(135deg, #0f766e 0%, #115e59 100%)`,icon:(0,_.jsx)(s,{size:15})}}return{label:e===`ar`?`إشعار`:`Alert`,colorClass:`badge-neutral`,gradientBorder:`var(--color-border)`,icon:(0,_.jsx)(d,{size:15})}};return(0,_.jsxs)(`div`,{className:`notifications-dashboard-container`,children:[(0,_.jsx)(`style`,{children:`
