import{d as e,l as t,n,o as r}from"./AppContext-YMbpJ_Ut.js";import{n as i,t as a}from"./PaginationBar-tig68OVC.js";import{t as o}from"./copy-37L4_gKX.js";import{t as s}from"./plus-BxizgokF.js";import{t as ee}from"./search-CMQ-VwQD.js";import{t as c}from"./trash-2-D9FXW45i.js";import{t as te}from"./user-COcBREog.js";import{A as ne,C as re,D as ie,S as l,i as u,r as d,t as ae,u as f,x as p}from"./index-BSoLdHzB.js";var oe=l(`check-check`,[[`path`,{d:`M18 6 7 17l-5-5`,key:`116fxf`}],[`path`,{d:`m22 10-7.5 7.5L13 16`,key:`ke71qq`}]]),m=l(`check`,[[`path`,{d:`M20 6 9 17l-5-5`,key:`1gmf2c`}]]),h=l(`circle-check`,[[`circle`,{cx:`12`,cy:`12`,r:`10`,key:`1mglay`}],[`path`,{d:`m9 12 2 2 4-4`,key:`dzmm74`}]]),se=l(`info`,[[`circle`,{cx:`12`,cy:`12`,r:`10`,key:`1mglay`}],[`path`,{d:`M12 16v-4`,key:`1dtifu`}],[`path`,{d:`M12 8h.01`,key:`e9boi3`}]]),g=l(`layers`,[[`path`,{d:`M12.83 2.18a2 2 0 0 0-1.66 0L2.6 6.08a1 1 0 0 0 0 1.83l8.58 3.91a2 2 0 0 0 1.66 0l8.58-3.9a1 1 0 0 0 0-1.83z`,key:`zw3jo`}],[`path`,{d:`M2 12a1 1 0 0 0 .58.91l8.6 3.91a2 2 0 0 0 1.65 0l8.58-3.9A1 1 0 0 0 22 12`,key:`1wduqc`}],[`path`,{d:`M2 17a1 1 0 0 0 .58.91l8.6 3.91a2 2 0 0 0 1.65 0l8.58-3.9A1 1 0 0 0 22 17`,key:`kqbvx6`}]]),_=l(`send`,[[`path`,{d:`M14.536 21.686a.5.5 0 0 0 .937-.024l6.5-19a.496.496 0 0 0-.635-.635l-19 6.5a.5.5 0 0 0-.024.937l7.93 3.18a2 2 0 0 1 1.112 1.11z`,key:`1ffxy3`}],[`path`,{d:`m21.854 2.147-10.94 10.939`,key:`12cjpa`}]]),ce=l(`sparkles`,[[`path`,{d:`M11.017 2.814a1 1 0 0 1 1.966 0l1.051 5.558a2 2 0 0 0 1.594 1.594l5.558 1.051a1 1 0 0 1 0 1.966l-5.558 1.051a2 2 0 0 0-1.594 1.594l-1.051 5.558a1 1 0 0 1-1.966 0l-1.051-5.558a2 2 0 0 0-1.594-1.594l-5.558-1.051a1 1 0 0 1 0-1.966l5.558-1.051a2 2 0 0 0 1.594-1.594z`,key:`1s2grr`}],[`path`,{d:`M20 2v4`,key:`1rf3ol`}],[`path`,{d:`M22 4h-4`,key:`gwowj6`}],[`circle`,{cx:`4`,cy:`20`,r:`2`,key:`6kqj1y`}]]),le=l(`volume-2`,[[`path`,{d:`M11 4.702a.705.705 0 0 0-1.203-.498L6.413 7.587A1.4 1.4 0 0 1 5.416 8H3a1 1 0 0 0-1 1v6a1 1 0 0 0 1 1h2.416a1.4 1.4 0 0 1 .997.413l3.383 3.384A.705.705 0 0 0 11 19.298z`,key:`uqj9uw`}],[`path`,{d:`M16 9a5 5 0 0 1 0 6`,key:`1q6k2b`}],[`path`,{d:`M19.364 18.364a9 9 0 0 0 0-12.728`,key:`ijwkga`}]]),v=e(t(),1),y=r();function b(){let{lang:e,t,triggerConfirm:r,canAction:l,setToastMessage:b}=n(),{availableGrades:x,fetchClasses:S}=ne(),{notifications:C,notificationsPagination:w,handleSendNotification:ue,handleMarkNotificationAsRead:T,handleDeleteNotification:de,handleDeleteAllNotifications:fe,fetchNotifications:pe,loading:me}=ie(),{students:E,fetchStudents:he}=ae(),{teachers:D,fetchTeachers:O}=re(),{page:k,perPage:A,search:j,setPage:ge,setPerPage:_e,setSearch:ve}=i({moduleKey:`notifications`}),[M,N]=(0,v.useState)(`all`),[ye,P]=(0,v.useState)(!1),[be,F]=(0,v.useState)(j),[I,L]=(0,v.useState)(``),[xe,R]=(0,v.useState)(null);(0,v.useEffect)(()=>{F(j)},[j]);let z=(0,v.useMemo)(()=>{let e=new URLSearchParams;return e.set(`page`,k),e.set(`per_page`,A),j&&e.set(`search`,j),M===`parents`?e.set(`type`,`broadcast_parents`):M===`teachers`?e.set(`type`,`broadcast_teachers`):(M===`classes`||M===`private`)&&e.set(`type`,`broadcast`),`?`+e.toString()},[k,A,j,M]);(0,v.useEffect)(()=>{pe(z)},[pe,z]),(0,v.useEffect)(()=>{S(),he(),O()},[S,he,O]);let[B,V]=(0,v.useState)(`parents`),[H,U]=(0,v.useState)(E.length>0?E[0].id:``),[W,G]=(0,v.useState)(x.length>0?x[0]:``),[Se,Ce]=(0,v.useState)(D.length>0?D[0].id:``),[K,q]=(0,v.useState)(``),[J,Y]=(0,v.useState)(``),[X,we]=(0,v.useState)(``),[Z,Te]=(0,v.useState)(``),Ee=(t,n)=>{t.stopPropagation(),r({title:e===`ar`?`حذف الإشعار`:`Delete Notification`,message:e===`ar`?`هل أنت متأكد من حذف هذا الإشعار نهائياً؟`:`Are you sure you want to permanently delete this notification?`,onConfirm:()=>{de(n)}})},De=()=>{r({title:e===`ar`?`حذف جميع الإشعارات`:`Delete All Notifications`,message:e===`ar`?`هل أنت متأكد من حذف جميع الإشعارات نهائياً؟ هذا الإجراء لا يمكن التراجع عنه!`:`Are you sure you want to delete all notifications permanently? This action cannot be undone!`,onConfirm:()=>{fe()}})},Oe=(t,n)=>{t.stopPropagation();let r=`${n.title}\n${n.content}`;navigator.clipboard.writeText(r),R(n.id),b&&b(e===`ar`?`تم نسخ نص الإشعار بنجاح`:`Notification content copied`),setTimeout(()=>R(null),2e3)},Q=t=>{t===`absence`?(q(e===`ar`?`تنبيه غياب وتأخر دراسي`:`Absence & Attendance Alert`),Y(e===`ar`?`نود إحاطتكم بحضور ومواظبة الطالب/الطالبة، نرجو المتابعة الحثيثة والتواصل مع إدارة المدرسة لضمان التفوق.`:`We would like to inform you regarding student attendance. Please follow up with school administration.`)):t===`exam`?(q(e===`ar`?`إعلان جدول الاختبارات النهائية`:`Final Exam Schedule Announcement`),Y(e===`ar`?`تم اعتماد ونشر جدول الاختبارات التقييمية. نرجو الحرص على مراجعة المقررات والالتزام بالحضور في المواعيد المحددة.`:`The evaluation exam schedule has been published. Please ensure thorough revision and timely attendance.`)):t===`parents_meeting`?(q(e===`ar`?`دعوة لاجتماع أولياء الأمور الدوري`:`Parents-Teachers Meeting Invitation`),Y(e===`ar`?`يسر إدارة المدرسة دعوتكم لحضور الاجتماع الدوري لمناقشة المستوى الأكاديمي والتربوي لأبنائنا الطلاب يوم الخميس القادم.`:`You are cordially invited to attend the periodic parents meeting next Thursday.`)):t===`general_announcement`&&(q(e===`ar`?`تعميم إداري هام للجميع`:`Important School Announcement`),Y(e===`ar`?`تود إدارة رياض ومدارس أنوار العلى الدولية تذكير جميع الطلاب وأولياء الأمور بالتعليمات والأنشطة القادمة.`:`Anwar Al-Ola Int. Model Schools would like to remind all students & parents of upcoming activities.`))},ke=t=>{if(t.preventDefault(),!K.trim()||!J.trim())return;let n=new Date().toISOString().replace(`T`,` `).substring(0,16),r={};if(B===`student`){let e=E.find(e=>e.id===Number(H));r={studentId:Number(H),studentName:e?e.name:null,studentNameEn:e?e.nameEn:null}}else if(B===`class`)r={grade:W};else if(B===`teacher`){let e=D.find(e=>e.id===Number(Se));r={teacherId:Number(Se),teacherName:e?e.name:null,teacherNameEn:e?e.nameEn:null}}let i={id:Date.now(),title:K,content:J,date:n,type:B,...r},a=[];if(B===`student`){let t=E.find(e=>e.id===Number(H));if(t){let r=e===`ar`?`تنبيه خاص بخصوص ابنكم ${t.name}: ${K} - ${J}. رياض و مدارس انوار العلى.`:`Private alert for ${t.nameEn}: ${K} - ${J}. Riyadh & Anwar Al-Ola.`;a.push({id:Date.now(),studentId:t.id,recipient:t.phone,text:r,time:n.split(` `)[1],type:`present`})}}else B===`class`?E.filter(e=>e.grade===W).forEach((t,r)=>{let i=e===`ar`?`تعميم لصف ${W}: ${K} - ${J}.`:`Class announcement for ${W}: ${K} - ${J}.`;a.push({id:Date.now()+Math.random()+r,studentId:t.id,recipient:t.phone,text:i,time:n.split(` `)[1],type:`present`})}):B===`parents`&&E.forEach((t,r)=>{let i=e===`ar`?`إشعار عام من المدرسة لأولياء الأمور: ${K} - ${J}.`:`Broadcast Announcement to Parents: ${K} - ${J}.`;a.push({id:Date.now()+Math.random()+r,studentId:t.id,recipient:t.phone,text:i,time:n.split(` `)[1],type:`present`})});ue(i,a),P(!1),q(``),Y(``),we(``),Te(``)},Ae=(0,v.useCallback)(t=>t.type===`attendance`?{name:e===`ar`?`مشرف التحضير`:`Prep Supervisor`,key:`supervisor`}:{name:e===`ar`?`إدارة المدرسة`:`School Administration`,key:`admin`},[e]),je=(0,v.useCallback)(t=>{if(!t)return``;try{let n=new Date(t.replace(` `,`T`)),r=new Date-n,i=Math.floor(r/(1e3*60)),a=Math.floor(r/(1e3*60*60)),o=Math.floor(r/(1e3*60*60*24));return i<2?e===`ar`?`الآن`:`Just now`:i<60?e===`ar`?`منذ ${i} دقيقة`:`${i}m ago`:a<24?e===`ar`?`منذ ${a} ساعة`:`${a}h ago`:o===1?e===`ar`?`أمس`:`Yesterday`:o<7?e===`ar`?`منذ ${o} أيام`:`${o}d ago`:t.substring(0,10)}catch{return t}},[e]),Me=w.total||C.length,Ne=(0,v.useMemo)(()=>C.filter(e=>e.type===`general`||e.type===`parents`||e.type===`broadcast_parents`).length,[C]),Pe=(0,v.useMemo)(()=>C.filter(e=>e.type===`class`).length,[C]),Fe=(0,v.useMemo)(()=>C.filter(e=>e.type===`student`||e.type===`private`||e.type===`teacher`).length,[C]),$=(0,v.useMemo)(()=>C.filter(e=>I&&!e.date.startsWith(I)?!1:M===`parents`?e.type===`parents`||e.type===`general`||e.type===`broadcast_parents`:M===`classes`?e.type===`class`:M===`teachers`?e.type===`teachers`||e.type===`teacher`||e.type===`broadcast_teachers`:M===`private`?e.type===`student`||e.type===`private`:!0),[C,I,M]);(0,v.useMemo)(()=>{let e=new Date().toISOString().substring(0,10),t=new Date;t.setDate(t.getDate()-1);let n=t.toISOString().substring(0,10),r={today:[],yesterday:[],earlier:[]};return $.forEach(t=>{let i=t.date?t.date.substring(0,10):``;i===e?r.today.push(t):i===n?r.yesterday.push(t):r.earlier.push(t)}),r},[$]);let Ie=(0,v.useMemo)(()=>C.filter(e=>!e.isRead).length,[C]),Le=(t,n,r,i,a,o)=>{if(t===`general`||t===`parents`||t===`broadcast_parents`)return{label:e===`ar`?`تعميم عام لأولياء الأمور`:`All Parents Broadcast`,bgGlow:`rgba(30, 80, 142, 0.08)`,borderColor:`var(--color-primary-ui)`,textColor:`var(--color-primary-ui)`,icon:(0,y.jsx)(u,{size:16})};if(t===`class`)return{label:e===`ar`?`الصف الدراسي: ${n||`عام`}`:`Class: ${n||`General`}`,bgGlow:`rgba(217, 119, 6, 0.08)`,borderColor:`#d97706`,textColor:`#b45309`,icon:(0,y.jsx)(g,{size:16})};if(t===`student`||t===`private`){let t=e===`ar`?r||`طالب مخصص`:i||r||`Private Student`;return{label:e===`ar`?`طالب: ${t}`:`Student: ${t}`,bgGlow:`rgba(225, 29, 72, 0.08)`,borderColor:`#e11d48`,textColor:`#be123c`,icon:(0,y.jsx)(f,{size:16})}}else if(t===`teachers`||t===`broadcast_teachers`)return{label:e===`ar`?`تعميم لجميع المعلمين`:`All Teachers Broadcast`,bgGlow:`rgba(16, 185, 129, 0.08)`,borderColor:`#10b981`,textColor:`#047857`,icon:(0,y.jsx)(u,{size:16})};else if(t===`teacher`){let t=e===`ar`?a||`معلم مخصص`:o||a||`Teacher`;return{label:e===`ar`?`المعلم: ${t}`:`Teacher: ${t}`,bgGlow:`rgba(15, 118, 110, 0.08)`,borderColor:`#0f766e`,textColor:`#0f766e`,icon:(0,y.jsx)(te,{size:16})}}return{label:e===`ar`?`إشعار إداري`:`System Alert`,bgGlow:`rgba(100, 116, 139, 0.08)`,borderColor:`#64748b`,textColor:`#475569`,icon:(0,y.jsx)(p,{size:16})}},Re=(0,v.useMemo)(()=>E.filter(e=>e.name.toLowerCase().includes(X.toLowerCase())||e.id.toString().includes(X)),[E,X]);return(0,v.useMemo)(()=>D.filter(e=>e.name.toLowerCase().includes(Z.toLowerCase())||e.id.toString().includes(Z)),[D,Z]),(0,y.jsxs)(`div`,{className:`notif-command-center`,children:[(0,y.jsx)(`style`,{children:`
