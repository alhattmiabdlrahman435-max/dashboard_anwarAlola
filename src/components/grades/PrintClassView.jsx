  ...
  return (
    <div style={{ display: 'none' }} className={`print-class-report printable-area ${classSubject === 'detailed' ? 'detailed-mode' : ''}`}>
      {classSubject === 'all' ? (
                ...
                <div key={s.id} className="student-report-card-page">
                  ...
                  <div className="printable-only-metadata" style={{ 
                    ...
                    <div>
                      ...
                      <span style={{ fontWeight: 'normal' }}>{lang === 'ar' ? s.name : s.nameEn}</span>
                      <span style={{ margin: '0 8px', color: '#94a3b8' }}>|</span>
                        ...
                        if (classPeriod === 'm1' || classPeriod === 'm2' || classPeriod === 'm3') {
                          ...
                          return (
                            <tr key={subj}>
                              ...
                              <td style={{ border: '1px solid #cbd5e1', padding: '8px 10px', textAlign: 'center', fontWeight: 'bold' }}>{total}</td>
                            </tr>
                          );
                          ...
                          return (
                            <tr key={subj}>
                              <td style={{ border: '1px solid #cbd5e1', padding: '8px 10px', fontWeight: '600', color: '#1e293b' }}>{subjectLabel}</td>
                              <td style={{ border: '1px solid #cbd5e1', padding: '8px 10px', textAlign: 'center' }}>{avg}</td>
                              <td style={{ border: '1px solid #cbd5e1', padding: '8px 10px', textAlign: 'center' }}>{sData.finalExam ?? 0}</td>
                              <td style={{ border: '1px solid #cbd5e1', padding: '8px 10px', textAlign: 'center', fontWeight: 'bold' }}>{total}</td>
                            </tr>
                          );
                        } else {
                          ...
                          return (
                            <tr key={subj}>
                              <td style={{ border: '1px solid #cbd5e1', padding: '8px 10px', fontWeight: '600', color: '#1e293b' }}>{subjectLabel}</td>
                              <td style={{ border: '1px solid #cbd5e1', padding: '8px 10px', textAlign: 'center' }}>{t1Val}</td>
                              <td style={{ border: '1px solid #cbd5e1', padding: '8px 10px', textAlign: 'center' }}>{t2Val}</td>
                              <td style={{ border: '1px solid #cbd5e1', padding: '8px 10px', textAlign: 'center', fontWeight: 'bold' }}>{yearlyVal}</td>
                            </tr>
                          );
                        }
                      })}
        ...
        <>
          <PrintHeader 
            title={`كشف رصد درجات الفصل التفصيلي (${classSubject}) - ${selectedClass}`}
            subtitle={lang === 'ar' 
              ? `العام الدراسي: ١٤٤٧ هـ | الفصل الدراسي: ${selectedGradeTerm === 'term1' ? t.term1Label : t.term2Label} | الفترة: ${
                  classPeriod === 'm1' ? t.m1Label 
                  : classPeriod === 'm2' ? t.m2Label 
